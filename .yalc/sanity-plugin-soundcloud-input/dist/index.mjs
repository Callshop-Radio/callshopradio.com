...
import { Stack, Text, Button, Select, Inline, Spinner, Card, Box, TextInput } from "@sanity/ui";
...
const DataFetcher = ({
  ...
  return /* @__PURE__ */ jsxs(Stack, { space: 4, children: [
    clientId && clientSecret && userId && /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsxs(Stack, { space: 2, children: [
        /* @__PURE__ */ jsx(Text, { size: 2, weight: "semibold", style: { marginBottom: "6px" }, children: "Choose Track Source" }),
    ...
    /* @__PURE__ */ jsx(Card, { padding: 0, style: { textAlign: "left" }, children: /* @__PURE__ */ jsx(Inline, { space: [3, 3, 4], children: /* @__PURE__ */ jsx(
      Button,
      {
        text: "API Settings",
        fontSize: [1, 1, 1],
  ...
  return /* @__PURE__ */ jsxs(Box, { padding: 3, border: !0, style: { borderRadius: "4px", marginBottom: "1rem" }, children: [
    ...
    /* @__PURE__ */ jsx(Button, { text: showDetails ? "Hide Details" : "Show Details", onClick: toggleDetails, tone: "primary" }),
  ...
  const { secrets } = useSecrets(namespace), [showSettings, setShowSettings] = useState(!1);
  if (useEffect(() => {
