...
var sanity = require("sanity"), jsxRuntime = require("react/jsx-runtime"), react = require("react"), ui = require("@sanity/ui"), icons = require("@sanity/icons"), studioSecrets = require("@sanity/studio-secrets");
const DataFetcher = ({
  clientId,
  clientSecret,
  userId,
  ...
  const namespace2 = "soundcloud", pluginConfigKeys2 = [
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.Stack, { space: 4, children: [
    clientId && clientSecret && userId && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      /* @__PURE__ */ jsxRuntime.jsxs(ui.Stack, { space: 2, children: [
        /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: 2, weight: "semibold", style: { marginBottom: "6px" }, children: "Choose Track Source" }),
            ...
            ui.Button,
            {
              ...
              onClick: () => {
                const selectedIds = selectedTrackIds.filter(
                  (id) => id !== void 0
                ), selectedTracksData = tracks.filter(
    ...
    /* @__PURE__ */ jsxRuntime.jsx(ui.Card, { padding: 0, style: { textAlign: "left" }, children: /* @__PURE__ */ jsxRuntime.jsx(ui.Inline, { space: [3, 3, 4], children: /* @__PURE__ */ jsxRuntime.jsx(
      ui.Button,
      {
        text: "API Settings",
        fontSize: [1, 1, 1],
...
}, namespace = "soundcloud", pluginConfigKeys = [
  { key: "clientId", title: "SoundCloud Client ID" },
  { key: "clientSecret", title: "SoundCloud Client Secret" },
  { key: "userId", title: "SoundCloud User ID" },
  { key: "websiteURI", title: "Website URI" }
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.Box, { padding: 3, border: !0, style: { borderRadius: "4px", marginBottom: "1rem" }, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(ui.Button, { text: showDetails ? "Hide Details" : "Show Details", onClick: toggleDetails, tone: "primary" }),
  ...
  const { secrets } = studioSecrets.useSecrets(namespace), [showSettings, setShowSettings] = react.useState(!1);
  if (react.useEffect(() => {
    secrets && setShowSettings(!1);
  }, [secrets]), showSettings)
  ...
  const clientId = secrets?.clientId || config.clientId, clientSecret = secrets?.clientSecret || config.clientSecret, userId = secrets?.userId || config.userId, websiteURI = secrets?.websiteURI || config.websiteURI, handleReset = () => {
...
const soundcloud = sanity.defineType({
  ...
  return (!config.clientId || !config.clientSecret || !config.userId || !config.websiteURI) && console.warn(
