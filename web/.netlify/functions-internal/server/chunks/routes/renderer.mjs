...
import { f as buildAssetsURL, u as useRuntimeConfig, h as defineRenderHandler, p as publicAssetsURL, i as getQuery, c as createError, j as getRouteRules, k as useNitroApp, l as getResponseStatusText, m as getResponseStatus } from '../nitro/nitro.mjs';
...
const getServerEntry = () => import('../build/server.mjs').then(function (n) { return n.z; }).then((r) => r.default || r);
