...
import { _ as _export_sfc, u as useMainStore, P as POOLARCHIVE_QUERY, g as groq, a as useHead } from './server.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "pool-archive" }, _attrs))} data-v-0fa21894>`);
      if (((_a2 = unref(data)) == null ? void 0 : _a2.modules) && unref(data).modules.length > 0) {
        _push(`<section class="module-section" data-v-0fa21894><!--[-->`);
        ssrRenderList(unref(data).modules, (module) => {
          _push(`<div class="module" data-v-0fa21894>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/pool/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0fa21894"]]);
