...
storage.mount('cache', unstorage_47drivers_47lru_45cache({"driver":"lru-cache","max":1000}));
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "bbb9cad7-6793-4093-a8b9-f60d1b2a80a0",
    ...
    "routeRules": {
      ...
      "/sitemap_index.xml": {
        "headers": {
          ...
          "X-Sitemap-Prerendered": "2026-01-25T20:24:24.958Z"
        },
        "swr": 600,
        "cache": {
          "swr": true,
  ...
  "public": {
    "baseUrl": "https://callshop.damianrosellen.xyz",
    "unlazy": {
      "ssr": true,
      "placeholderSize": 32
    },
  ...
  "sanityWebhookSecret": "16a7d369-caa5-4d77-9c7b-5c6290c692bc",
  "sanity": {
    "visualEditing": {
      "mode": "live-visual-editing",
      "previewMode": {
      ...
      "studioUrl": "http://callshopradio.sanity.studio",
      "zIndex": "",
      "previewModeId": "6dd46149c7a031dc728342d3415bf45d",
  ...
  "nuxt-site-config": {
    "stack": [
      ...
      },
      {
        ...
        "url": "https://callshop.damianrosellen.xyz"
      },
      {
        "_context": "buildEnv",
        "_priority": -1,
...
const _Kh1seOxtruPSXUaIeBzQRRbXHIAzmtpxTtBqo8fkUY = defineNitroPlugin(async (nitroApp) => {
...
const _abZZ0QzznVjCDi1h89UcbYddsPbHHoAejfbZ7zFEDUY = defineNitroPlugin(async (nitroApp) => {
  console.log("\u{1F5FA}\uFE0F Sitemap plugin loaded");
  nitroApp.hooks.hook("close", async () => {
    try {
      console.log("\u{1F504} Sitemap plugin shutting down...");
    } catch (error) {
  ...
  nitroApp.hooks.hook("request", async (event) => {
    var _a;
    if ((_a = event.node.req.url) == null ? void 0 : _a.includes("/sitemap")) {
      console.log("\u{1F5FA}\uFE0F Sitemap request:", event.node.req.url);
    }
  });
});

const plugins = [
  _Kh1seOxtruPSXUaIeBzQRRbXHIAzmtpxTtBqo8fkUY,
_abZZ0QzznVjCDi1h89UcbYddsPbHHoAejfbZ7zFEDUY
];

const _Ct3ZnL = defineEventHandler(async (event) => {
...
const _oCoHUJ = defineEventHandler(async (event) => {
  const $config = useRuntimeConfig(event);
  const sanity = useSanity();
  const sanityConfig = defu($config.sanity, $config.public.sanity);
  const client = sanity.client.withConfig({
...
const _BZDtyQ = defineEventHandler(async (e) => {
...
const _bwaySp = defineEventHandler(async (e) => {
...
const _RaXEYa = defineEventHandler(async (e) => {
...
const _ok7246 = defineEventHandler(async (e) => {
  const runtimeConfig = useSimpleSitemapRuntimeConfig();
  const { sitemaps } = runtimeConfig;
...
const _lazy_Pjc1Ds = () => import('../routes/api/revalidate.mjs');
const _lazy_MXGEq1 = () => import('../routes/api/sitemap.mjs');
const _lazy_RnjdCw = () => import('../routes/sitemap.xml.mjs');
const _lazy_P4brlr = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/revalidate', handler: _lazy_Pjc1Ds, lazy: true, middleware: false, method: undefined },
  { route: '/api/sitemap', handler: _lazy_MXGEq1, lazy: true, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _lazy_RnjdCw, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_P4brlr, lazy: true, middleware: false, method: undefined },
  { route: '/_sanity/fetch', handler: _Ct3ZnL, lazy: false, middleware: false, method: "post" },
  { route: '/preview/enable', handler: _oCoHUJ, lazy: false, middleware: false, method: "get" },
  { route: '/preview/disable', handler: _W0tsz4, lazy: false, middleware: false, method: "get" },
  { route: '', handler: _2t3j6W, lazy: false, middleware: true, method: undefined },
  { route: '/sitemap_index.xml', handler: _BZDtyQ, lazy: false, middleware: false, method: undefined },
  { route: '/en-US-sitemap.xml', handler: _bwaySp, lazy: false, middleware: false, method: undefined },
  { route: '/de-DE-sitemap.xml', handler: _bwaySp, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _RaXEYa, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _ok7246, lazy: false, middleware: false, method: undefined },
  { route: '/pool', handler: _lazy_P4brlr, lazy: true, middleware: false, method: undefined },
  { route: '/shows', handler: _lazy_P4brlr, lazy: true, middleware: false, method: undefined },
  { route: '/words', handler: _lazy_P4brlr, lazy: true, middleware: false, method: undefined },
  { route: '/schedule', handler: _lazy_P4brlr, lazy: true, middleware: false, method: undefined },
  { route: '/index-sitemap.xml', handler: _lazy_P4brlr, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_P4brlr, lazy: true, middleware: false, method: undefined }
];
...
export { klona as A, parse as B, getRequestHeader as C, isEqual as D, setCookie as E, getCookie as F, deleteCookie as G, handler as H, useStorage as a, useSanity as b, createError$1 as c, defineEventHandler as d, groq as e, buildAssetsURL as f, getHeader as g, defineRenderHandler as h, getQuery as i, getRouteRules as j, useNitroApp as k, getResponseStatusText as l, getResponseStatus as m, createHooks as n, getContext as o, publicAssetsURL as p, createRouter$1 as q, readBody as r, setHeader as s, toRouteMatcher as t, useRuntimeConfig as u, defu as v, sanitizeStatusCode as w, executeAsync as x, getRequestHeaders as y, destr as z };
