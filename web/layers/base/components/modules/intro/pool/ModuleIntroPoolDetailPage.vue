    ...
    <div ref="poolMainRef" class="pool-intro-content">
      <div class="pool-container">
        <div class="pool-details-inner">
          ...
          <!-- Referenzierte Personen (mit blauem Pin-Icon) -->
          <section
            v-if="
          ...
          <!-- Referenzierte Veranstaltungsorte (mit blauem Pin-Icon) -->
          <section
            v-if="
              poolItem._type === 'person' &&
              poolItem.venues &&
          ...
          <!-- Contact & Socials (mit Icons) -->
          <section
            v-if="poolItem?.contact || poolItem?.socials"
            class="pool-contact-section pool-tags tags"
          >
            <div class="pool-socials pool-tags tags">
              <a
                v-if="poolItem?.contact"
                :href="contactLink"
                target="_blank"
              ...
              <a
                v-if="poolItem?.socials?.instagram"
                :href="poolItem.socials.instagram"
                target="_blank"
                rel="noopener noreferrer"
              ...
              >
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <circle cx="11.1062" cy="11.4773" r="9.56522" fill="white" />
                  <path
              ...
              <a
                v-if="poolItem?.socials?.soundcloud"
                :href="poolItem.socials.soundcloud"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                v-if="poolItem?.socials?.nina"
                :href="poolItem.socials.nina"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Nina"
                class="tag"
              >
                <span class="social-icon">Nina</span>
              </a>
              <a
                v-if="poolItem?.socials?.bandcamp"
                :href="poolItem.socials.bandcamp"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Bandcamp"
                class="tag"
              >
                <span class="social-icon">Bandcamp</span>
              </a>
              <a
                v-if="poolItem?.socials?.web"
                :href="poolItem.socials.web"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Website"
                class="tag tag-icon"
