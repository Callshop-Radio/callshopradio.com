    ...
    <div class="article-container">
      ...
      <div class="article-media">
        ...
        <div class="article-tags">
          <div class="article-socials tags">
            <a
              v-if="article?.socials?.instagram"
              :href="article?.socials?.instagram"
              target="_blank"
            ...
            <a
              v-if="article?.socials?.soundcloud"
              :href="article?.socials?.soundcloud"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              v-if="article?.socials?.nina"
              :href="article?.socials?.nina"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Nina"
            >
            ...
            <a
              v-if="article?.socials?.bandcamp"
              :href="article?.socials?.bandcamp"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Bandcamp"
            >
            ...
            <a
              v-if="article?.socials?.web"
              :href="article?.socials?.web"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Website"
              ><svg
      ...
      <div class="article-info">
        <div class="article-info-container">
          ...
          <div v-if="article?.text" class="article-text-container">
            <RichText class="article-text" :blocks="parseI18nObj(article?.text)" />
          </div>
        </div>
      </div>
    </div>
...
.article-media {
  ...
  .article-category {
    position: absolute;
    bottom: 0;
    left: calc(50svw - var(--page-max-width) / 2);
...
.article-title-section {
  width: var(--page-max-width);
  margin: calc(var(--base-margin) + var(--big-margin)) auto var(--big-margin);
  .article-title {
