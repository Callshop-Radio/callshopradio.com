import { BlockElementIcon, CogIcon, TextIcon } from "@sanity/icons";
...
export const moduleContentReferenceSlider = defineType({
  ...
  fields: [
    ...
    },
    {
      ...
      hidden: ({ parent }) =>
        (parent?.type === "pool" && parent?.autoLoad === false) ||
        parent?.type !== "pool",
    },
    {
      name: "pool",
      ...
      group: "editorial",
      hidden: ({ parent }) =>
        (parent?.type === "pool" && parent?.autoLoad === true) ||
        parent?.type !== "pool",
      of: [
        {
          name: "person",
    ...
    },
    {
      ...
      group: "editorial",
      hidden: ({ parent }) =>
        (parent?.type === "words" && parent?.autoLoad === true) ||
        parent?.type !== "words",
      of: [
        {
          name: "article",
    ...
    },
    {
      ...
      group: "editorial",
      hidden: ({ parent }) =>
        (parent?.type === "shows" && parent?.autoLoad === true) ||
        parent?.type !== "shows",
      of: [
        {
          name: "show",
    ...
    },
    {
      ...
      group: "editorial",
      hidden: ({ parent }) =>
        (parent?.type === "sets" && parent?.autoLoad === true) ||
        parent?.type !== "sets",
      of: [
        {
          name: "set",
