...
const TITLE = 'Shows Archive Page'

export const showsArchive = defineType({
  name: 'showsArchive',
  type: 'document',
  title: TITLE,
  icon: UlistIcon,
    ...
    },    
{
  ...
  fields: [
    ...
    },
    {
      ...
      fields: [
        {
          title: 'Number of visible Sets',
          name: 'count',
          type: 'number',
          initialValue: 6,
          options: {
            list: [
              {value: 2, title: "2"}, {value: 4, title: "4"}, {value: 6, title: "6"}, {value: 8, title: "8"}, {value: 10, title: "10"}
            ],
            layout: 'radio',
    ...
    },
    {
      title: 'Modules',
      name: 'modules',
      description: 'Modules will appear below the Shows Archive view.',
      type: 'modules',
      group: 'editorial',
    },
    {
