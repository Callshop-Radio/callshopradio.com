...
const DataFetcher = (props) => {
  const { clientId, clientSecret, onSuccess } = props, [isFetching, setIsFetching] = react.useState(!1), [errorMsg, setErrorMsg] = react.useState(""), [tracks, setTracks] = react.useState([]), [selectedTracks, setSelectedTracks] = react.useState([]), [cachedAccessToken, setCachedAccessToken] = react.useState(null), fetchAccessToken = async () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.Stack, { space: 4, children: [
    (!clientId || !clientSecret) && /* @__PURE__ */ jsxRuntime.jsxs(ui.Inline, { space: [2], children: [
      /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: 2, children: "Missing" }),
      /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: 2, style: { fontWeight: "bold" }, children: "Client ID or Client Secret" })
    ] }),
    clientId && clientSecret && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(ui.Button, { text: "Fetch Tracks", onClick: fetchTracks, disabled: isFetching, tone: "primary" }),
      isFetching && /* @__PURE__ */ jsxRuntime.jsx(ui.Spinner, { muted: !0 }),
      tracks.length > 0 && /* @__PURE__ */ jsxRuntime.jsx(ui.Select, { onChange: handleSelectChange, value: selectedTracks.map(String), multiple: !0, children: tracks.map((track) => /* @__PURE__ */ jsxRuntime.jsx("option", { value: track.id.toString(), children: track.title }, track.id)) }),
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.Card, { children: [
    !value && /* @__PURE__ */ jsxRuntime.jsx(DataFetcher, { clientId, clientSecret, onSuccess: setTrackData }),
    value && /* @__PURE__ */ jsxRuntime.jsxs(ui.Stack, { space: 4, children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(ui.Stack, { space: 3, children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(ui.TextInput, { fontSize: 2, padding: 3, readOnly: !0, value: value?.title })
      ] }),
      /* @__PURE__ */ jsxRuntime.jsxs(ui.Stack, { space: 3, children: [
        /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: 1, weight: "semibold", children: "Artwork" }),
        value?.artwork_url && /* @__PURE__ */ jsxRuntime.jsx(
          "img",
          {
